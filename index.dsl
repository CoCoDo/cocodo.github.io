		...
		<div class="tabber">
			<div class="tabbertab">
				...
				<ul class="cool">
					...
					<li>
						<strong>17:00–18:30</strong>: From Abstract Syntax Trees to Machine Code with <a href="https://llvm.org/">LLVM</a> (<a href="https://kyouko-taiga.github.io/">Dimitri Racordon</a>)
						<ul>
							<li>
								(<a href="https://github.com/kyouko-taiga/Cocodol">Cocodol</a>)
								(<a href="llvm.pdf">slides</a>)
								(<a href="https://llvm.org/docs/GettingStarted.html">getting started</a>)
							</li>
						</ul>
					</li>
				</ul>
				...
				<ul>
					<li>Johan Fabry, Vadim Zaytsev, <strong>4th Raincode Labs Compiler Coding Dojo, Welcome from the Chairs</strong> <span class="red"><a href="https://dl.acm.org/action/showFmPdf?doi=10.1145%2F3464432">(doi:10.1145/3464432, pp. XI–XVIII)</a></span></li>
					<li>Dimitri Racordon, <strong>From ASTs to Machine Code with LLVM</strong> <span class="red"><a href="https://doi.org/10.1145/3464432.3464777">(doi:10.1145/3464432.3464777, pp. 68–76)</a></span></li>
				</ul>
			</div>
			<div class="tabbertab">
				<h2>2019</h2>
